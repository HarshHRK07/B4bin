...
def format_bin_message(bin_number, bin_info, card_info, api_response):
    label = "CREDIT BIN" if bin_info.get(
        'type') == "CREDIT" else "DEBIT/PREPAID BIN"
    ...
    if 'error' in api_response:
        ...
        message += ("━━━━━━━━━━━━━━━━━━━━━━━\n"
                    f"⚠️ Error Code: `{error.get('code', 'N/A')}`\n"
                    f"⚠️ Decline Code: `{error.get('decline_code', 'N/A')}`\n"
                    f"🔗 Doc URL: `{error.get('doc_url', 'N/A')}`\n"
                    "━━━━━━━━━━━━━━━━━━━━━━━")
...
def generate_and_send_bins():
    while True:
        ...
        if "error" not in bin_info:
            ...
            if "error" in api_response and api_response[
                ...
                message = format_bin_message(bin_number, bin_info, card_info,
                                             api_response)
